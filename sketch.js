...
function draw() {
  ...
  //if (collide(fruit, p2, 20) == true) {
    
    //bubble.visible = false;

   // engine.world.gravity.y = -1;
    //fruit.position.x = p1.position.x;
    //fruit.position.y = p1.position.y;
    
  //}

 if(collide(fruit, p1, 30) == true){
   engine.world.gravity.y = -0.1;
    fruit.position.x = p2.position.x;
    fruit.position.y = p2.position.y;
 }
  drawSprites();
